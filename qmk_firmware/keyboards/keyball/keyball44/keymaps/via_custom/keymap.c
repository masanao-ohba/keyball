...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    LCTL_T(KC_TAB),      KC_A,      KC_S,      KC_D,      KC_F,      KC_G,       KC_H,      KC_J,      KC_K,      KC_L,   KC_QUOT,   KC_MINS,
      KC_LSFT,      KC_Z,      KC_X,      KC_C,      KC_V,      KC_B,       KC_N,      KC_M, MT(MOD_LCTL|MOD_RCTL,KC_COMM),    KC_DOT, LT(2,KC_SLSH), MT(MOD_LSFT|MOD_RSFT,KC_LBRC),
            KC_LNG1, LT(2,KC_LNG2), MT(MOD_LGUI,KC_SPC), MT(MOD_LALT,KC_ENT),   KC_CAPS,  MT(MOD_LALT|MOD_RALT,KC_ENT), MT(MOD_LGUI|MOD_RGUI,KC_SPC), MT(MOD_LCTL|MOD_RCTL,KC_LNG2),   KC_RALT,   KC_LNG1
  ),
  ...
  [2] = LAYOUT_universal(
      ...
      KC_LSFT,   _______,   _______,   _______,   _______,   _______,    _______,   _______,   KC_COMM,    KC_DOT,   _______,   KC_RSFT,
  ...
  [3] = LAYOUT_universal(
      ...
      _______,     KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,      KC_NO,     KC_NO,   KC_RBRC,   KC_NUHS,   KC_SLSH,   KC_INT3,
            _______,   KC_LSFT, MT(MOD_LGUI,KC_SPC), MT(MOD_LSFT,KC_LALT),   _______,  MT(MOD_LALT|MOD_RALT,KC_ENT), MT(MOD_LGUI|MOD_RGUI,KC_SPC),   _______, S(KC_INT1), S(KC_INT1)
  ),
};
// clang-format on
